 ...
 *
 *   node app/scripts/modelo-2026.mjs "docs/<libro real>.xlsx" [salida.ods]
 *
...
function leeme(m, origen) {
  ...
  return [
    ...
    [],
    ['Generado por app/scripts/modelo-2026.mjs a partir de:', origen],
...
function main() {
  ...
  if (!entrada) {
    console.error('Uso: node app/scripts/modelo-2026.mjs <libro.xlsx> [salida.ods]');
    process.exit(2);
  }
